...
<body>
    ...
    <main>
        ...
        <div class="col-xl-7 container contenedor pt-3">
            ...
            <form id="formRegistroUsuario" name="formRegistro" class="login-form container-fluid">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group input-container">
                            ...
                            <input name="nombre" pattern="^[^0-9]{2,40}$" class="form-control" type="text" required
                                placeholder="Ingrese su nombre" title="Debe contener mas de 2 caracteres y no contener numeros">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group input-container ">
                            <i class="icono-user"></i>
                            <!-- Tomamos la caracteristica form-control para estilo completo y relleno suficiente, pertence a bootstrap borre logininput pues no lo encontre en css avisenme si hice algo mal -->
                            <input name="apellido" pattern="^[^0-9]{2,40}$" class="form-control" type="text" required
                                placeholder="Ingrese su apellido" title="Debe contener mas de 2 caracteres y no contener numeros">
                            <div class="invalid-tooltip"></div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group input-container">
                            ...
                            <!-- Tomamos la caracteristica form-control para estilo completo y relleno suficiente, pertence a bootstrap borre logininput pues no lo encontre en css avisenme si hice algo mal -->
                            <input name="correo" pattern="^[^@]+@[^@]+$" class="form-control" type="email" required
                                placeholder="Ingrese su correo electrónico" title="Debe contener mas de @">
                            <div class="invalid-tooltip"></div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group input-container">
                            ...
                            <select name="pais" id="dropPais" class="form-control" required placeholder="Ingrese pais"
                                title="Debe seleccionar un pais de la lista">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group input-container ">
                            <i class="icono-world"></i>
                            <!-- Tomamos la caracteristica form-control para estilo completo y relleno suficiente, pertence a bootstrap borre logininput pues no lo encontre en css avisenme si hice algo mal -->
                            <input name="provincia" pattern="^[^0-9]+$" class="form-control" type="text" required
                                placeholder="Ingrese su provincia" title="Debe contener mas de 1 caracter">
                            <div class="invalid-tooltip"></div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group input-container">
                                ...
                                <input name="nombre" class="form-control" type="text" required
                                    placeholder="Ingrese su nombre" title="Debe contener mas de 2 caracteres">
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group input-container ">
                                ...
                                <input name="apellido" class="form-control" type="text" required
                                    placeholder="Ingrese su apellido" title="Debe contener mas de 2 caracteres">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group input-container ">
                                ...
                                <input name="correo" class="form-control" type="email" required
                                    placeholder="Ingrese su correo" title="Debe contener mas de 2 caracteres">
                            </div>
                        </div>
                    </div>
                    <div class="row">
