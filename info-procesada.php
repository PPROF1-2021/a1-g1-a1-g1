...
if (!empty($_POST)) {
    if (isset($_POST['codigo-empresa'])) {
        ...
        $sql = "SELECT Nombre, Descripcion FROM Empresas WHERE Codigo = '$cod'";
        $res = $connection -> query($sql) -> fetch_all();
        console_log($res);
        $nombreEmpresa = $res[0][0];
        $descripcionEmpresa = $res[0][1];
        
    }
    else{
        $nombreEmpresa = $_POST['empresa-nombre'];
        $descripcionEmpresa = $_POST['empresa-descripcion'];
    }
}
?>
                                ...
                                <fieldset class="row g3">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" aria-describedby="inputGroupEmpresaNombre" disabled value="<?php echo $nombreEmpresa ?>" data-minage="13" class="form-control rounded col-auto pr-3">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" aria-describedby="inputGroupEmpresaDescripcion" disabled value="<?php echo $descripcionEmpresa ?>" class="form-control rounded col-auto pr-3">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" aria-describedby="inputGroupEmpresaCodigo" disabled value="<?php echo $cod ?>" class="form-control rounded col-auto pr-3">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
